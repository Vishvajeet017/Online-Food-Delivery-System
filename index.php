...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/coffee_cup_saucer_grains_foam_73571_1920x1080.jpg" alt="Los Angeles" class="d-block w-100">
    ...
    <div class="carousel-item">
      <img src="img/chennaifood.jpg" alt="Chicago" class="d-block w-100">
      <div class="carousel-caption">
        <h3>Chennai</h3>
...
<div class="container-fluid">
  <div class="row">
	...
	<div class="container-fluid">
	 ...
	 <div class="container">
	 <p style="font-family: 'Century Gothic', cursive; font-weight:light;  font-size:65px;">Late from work?</p>
	 <p style="font-family: 'Century Gothic', cursive; font-weight:light;  font-size:40px;">Order your favourite food from your favourite restaurent sitting at home.</p>
	 </div>
...
<div class="container-fluid">
     <div class="row"><!--main row-->
	   ...
	   <div class="col-sm-6">
	        ...
	        <div class="container">
	        <!--paragraph content--> 
			<p style="font-family: 'Century Gothic', cursive; font-weight:light;  font-size:65px;">Hungry?</p>
	 		<p style="font-family: 'Century Gothic', cursive; font-weight:light;  font-size:40px;">Order in for yourself or for the group, with no restrictions on order value.</p>
	        </div>
	  </div>
