...
<div class="middle" style=" position:fixed; padding:50px; border:1px solid orange; left:38%; top:30%; width:400px;">
       <ul class="nav nav-tabs nabbar_inverse" id="myTab" style="background:orange;border-radius:10px 10px 10px 10px;" role="tablist">
          <li class="nav-item">
