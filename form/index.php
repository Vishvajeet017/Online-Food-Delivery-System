...
<div class="middle" style=" margin:50px auto;width:500px;">
       <ul class="nav nav-tabs nabbar_inverse" id="myTab" style="background:#ffa500;border-radius:10px 10px 10px 10px;" role="tablist">
          <li class="nav-item">
             <a class="nav-link active" style="color:#fde0bd;" id="login-tab" data-toggle="tab" href="#login" role="tab" aria-controls="login" aria-selected="true">Log In</a>
          </li>
          <li class="nav-item">
              <a class="nav-link" id="signup-tab" style="color:#fde0bd;" data-toggle="tab" href="#signup" role="tab" aria-controls="signup" aria-selected="false">Create New Account</a>
          </li>
       </ul>
	   <br><br>
	   ...
	   <!--login Section-- starts-->
            <div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="home-tab">
			  ...
			  <form method="post" enctype="multipart/form-data">
                  ...
                  <button type="submit" name="login" style="background:#ffa500; border:1px solid #ffa500;" class="btn btn-primary">Login In</button>
            ...
            <div class="tab-pane fade" id="signup" role="tabpanel" aria-labelledby="profile-tab">
			    <form method="post" enctype="multipart/form-data">
                  ...
                  <button type="submit" name="register" style="background:#ffa500; border:1px solid #ffa500;" class="btn btn-primary">Create New Account</button>
                  <div class="footer" style="color:red;"><?php if(isset($ermsg)) { echo $ermsg; }?><?php if(isset($ermsg2)) { echo $ermsg2; }?></div>
			 </form>
			</div>
